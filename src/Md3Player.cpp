/////////////////////////////////////////////////////////////////////////////
//
// Original MD3 player Copyright (c) 2006-2007 David Henry
// last modification: may. 7, 2007
// This code is licenced under the MIT license.
// Heavily modified by David Lee and Paul-Michael Sorhaindo
//
  ...
  throw (Md3Exception)
{
  ...
  Vectormath::Aos::Vector3 Md3Player::getOriginLower()
  {
	  Vectormath::Aos::Vector3 origin;
	  	  origin = _lower->getLocalOrigin();
	  	  return origin;
  }

  Vectormath::Aos::Vector3 Md3Player::getOriginUpper()
  {
	  Vectormath::Aos::Vector3 origin;
	  	  origin = _upper->getLocalOrigin();
	  	  return origin;
  }

  Vectormath::Aos::Vector3 Md3Player::getOriginHead()
  {
	  Vectormath::Aos::Vector3 origin;
	  	  origin = _head->getLocalOrigin();
	  	  return origin;
  }

  float Md3Player::getRadiusLower()
  {
		float rad;
		rad= _lower->getRadius();
		return rad;
  }

  float Md3Player::getRadiusUpper()
  {
		float rad;
		rad= _lower->getRadius();
		return rad;
