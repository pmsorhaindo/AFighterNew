...
public:
  ...
  Md3Player (const string &path, Md3PlayerLOD lod = kLodDefault)
    throw (Md3Exception);
  ~Md3Player ();
  Vectormath::Aos::Vector3 getOriginLower();
  Vectormath::Aos::Vector3 getOriginUpper();
  Vectormath::Aos::Vector3 getOriginHead();
  float getRadiusLower();
  float getRadiusUpper();
  float getRadiusHead();
